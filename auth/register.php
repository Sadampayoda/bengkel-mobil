            ...
            <div class="col-9 mt-5">
                <div class="row d-flex justify-content-center">
                    <div class="col-5 border-bottom p-2 text-center ">
                        <h1>SAM JAYA</h1>
                        <p>Daftar Website Dashboard Bengkel Mobil</p>
                    </div>
                </div>
                    ...
                    <div class="row d-flex justify-content-center py-2">
                        ...
                        <div class="col-5">
                            ...
                            <div class="mb-3">
                                ...
                                <input required type="text" name="name" id="name" class="form-control" placeholder="Masukan username Anda">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-5">
                                ...
                                <input required type="password" name="konfirmasi" id="konfirmasi" class="form-control" placeholder="Masukan Konfirmasi Password Anda">
                            </div>
                            <div class="d-grid mb-3">
                                <button type="button" onclick="onRegister('form-register')" class="btn btn-dark">
                                    Daftar akun
                                </button>
                            </div>
                            <div class="mb-3 p-4 border-top text-center">
                                <p>Sudah punya akun? Masuk <a href="<?= BASE_URL ?>/auth/login.php">Disini</a> </p>
                            </div>
                        </div>
                    </div>
                </form>
